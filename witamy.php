...
<body class="hero" background="loginnn_back.png">
	...
	<div class="srodek">
	<div>
		<button type="submit" class="submit-btn1" onClick="location.href='index.php'" value='click here'>Przejdz do logowania</button>
	<br><b>Dziękujemy za rejestrację w serwisie! Możesz już zalogować się na swoje konto!</b>
</div>
</div>
